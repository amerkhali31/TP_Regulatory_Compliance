...
INVOICE_DATA_FILE_NAME = f"{DATA_PATH}/JANUARY_INVOICES7.xlsx"
INVOICE_SHEET_NAME = "Sheet1"
AGGREGATED_BOOK_INVOICE_SHEET_NAME = "Invoices"

CUSTOMER_DATA_FILE_NAME = f"{DATA_PATH}/JANUARY_CUSTOMERS4.xlsx"
CUSTOMER_SHEET_NAME = "Sheet1"
AGGREGATED_BOOK_CUSTOMER_SHEET_NAME = "Customers"

PRODUCT_DATA_FILE_NAME = f"{DATA_PATH}/JANUARY_PRODUCTS4.xlsx"
