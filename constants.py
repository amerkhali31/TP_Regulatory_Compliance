...
MANUFACTURERS = {
    ...
    'BREEZE' : 'BREEZE SMOKE LLC',
    'FRONTO LEAF' : 'THE ORIGINAL FRONTO LEAF LLC',
    'GEEK' : 'SHENZHEN GEEKVAPE TECHNOLOGY CO LTD',
    'GRABBA LEAF' : 'GRABBALEAF LLC',
    'HAVANA' : 'HAVANALEAF LLC',
}
